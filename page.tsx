...
export default function Home() {
  ...
  return (
    <Navbar>
        ...
        <div className="flex flex-col lg:flex-row items-center md:gap-32 mt-16 lg:mt-0 gap-4">
          <div className="flex flex-col items-center md:items-start">
            <h1 className="flex gap-2 md:w-[387px] font-bold text-2xl md:text-3xl mb-2 text-center">
              ...
              <Typewriter
                options={{
                  strings: ['Compete', 'Connect', 'Succeed'],
                  autoStart: true,
                  loop: true,
                }}
              />
        ...
        <AnimatedSection className="flex flex-col lg:flex-row justify-center items-center min-h-[50vh] w-full py-16 px-4 gap-8 md:gap-16 sm:px-12 lg:gap-32">
          <div className="flex flex-col gap-2 max-w-3xl">
            ...
            <p className="max-w-2xl text-center md:text-left">
              ...
              Our mission is to connect students nationwide through <a href="#programs" className="text-purple-400 hover:underline">various programs</a> including collaborative coding, competitions, and project-based learning,
      ...
      {/* Our Programs */}
      <div className="flex flex-col w-full min-h-screen justify-center items-center px-4 py-16">
        <AnimatedSection className="flex flex-col justify-center items-center">
          ...
          <p className="max-w-4xl text-center">
            ...
            form <Link href="https://forms.gle/xHVMcjPW9kzxhgfC7" className="text-purple-400 hover:underline" target="_blank">here</Link> or
            through <Link href="/contact" className="text-purple-400 hover:underline">our contact page</Link>
          </p>
        </AnimatedSection>
      ...
      <WaveDivider direction="top" fillColor="rgb(168,85,247)" className="mb-[-10px]" />
      <div className="w-full bg-purple-500 text-white py-16">
        <AnimatedSection className="max-w-screen-xl mx-auto px-4 flex flex-col items-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-center">Join Us Today!</h2>
          <p className="text-center mb-6 max-w-md px-4">
            Be a part of the NSACC community to unlock networking opportunities, showcase your skills, and build a foundation for success in tech. Do not miss this chance to grow and excel!
          </p>
          <Button asChild variant={"secondary"} size={"lg"}>
            <Link target='_blank' href="https://forms.gle/9cAKaWxixZu7WHP5A"><span className="text-purple-500">Join Waitlist Now!</span></Link>
          </Button>
        </AnimatedSection>
        <AnimatedSection>
          <Footer />
