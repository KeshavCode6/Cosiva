...
import { Twitter, Facebook, Instagram, Mail, Youtube } from 'lucide-react'
        ...
        <footer>
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                ...
                <div className="flex items-center justify-between">
                    <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 Cosiva</span>
                    <div className="flex mt-4 sm:mt-0 space-x-2 justify-center sm:justify-start">
                        ...
                        <Button variant="outline" size="icon" asChild>
                            <Link href="https://www.youtube.com/@cosivanonprofit" aria-label="Twitter" target='_blank'>
                                <Youtube className="h-4 w-4" />
                            </Link>
                        </Button>
                        <Button variant="outline" size="icon" asChild>
                            <Link href="https://www.facebook.com/cosivanonprofit" aria-label="Facebook" target='_blank'>
                                <Facebook className="h-4 w-4" />
                            </Link>
                        </Button>
                        <Button variant="outline" size="icon" asChild>
                            <Link href="https://www.instagram.com/cosivanonprofit" aria-label="Instagram" target='_blank'>
